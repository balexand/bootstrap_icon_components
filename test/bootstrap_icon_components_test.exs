defmodule BootstrapIconComponentsTest do
  ...
  test "TestIcons.icon_1_circle" do
    assert render_component(&TestIcons.icon_1_circle/1) ==
             String.trim("""
    ...
    assert render_component(&TestIcons.icon_1_circle/1, %{class: "w-4"}) ==
             String.trim("""
  ...
  test "TestIcons.icon_cpu" do
    assert render_component(&TestIcons.icon_cpu/1, %{class: "h-4"}) ==
             String.trim("""
